...
<img src="img/muffin-machine.svg" style="max-width:300px;width:100%;"/>
...
- True negative rate, or *specificity*:&nbsp;&nbsp;tnr = $\frac{tn}{n}$ = <span id="specificity"></span>
- False positive rate:&nbsp;&nbsp;fpr = $\frac{fp}{n}$ = <span id="fpr"></span>
- False negative rate:&nbsp;&nbsp;fnr = $\frac{fn}{p}$ = <span id="fnr"></span>
- Positive predicted value, or *precision*:&nbsp;&nbsp;ppv = $\frac{tp}{tp + fp}$ = <span id="precision"></span>
